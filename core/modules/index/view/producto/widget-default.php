...
<?php endif; ?>
  ...
  <div class="col-md-9">
    <div style="background:#ED3ACF;font-size:25px;color:white;padding:5px;"><?php echo $p->name; ?></div>
<br>
<?php if($p!=null):
...
?>
  <div class="row">
  <div class="col-md-8">
 <center>   <img src="<?php echo $img; ?>"  style="width:180px;height:180px; border-radius: 29px 29px 29px 29px;
